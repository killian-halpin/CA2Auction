...
//    }
    ...
    public void addauctionlotDetails() {
        auctionLot lot = new auctionLot(auctionLotName.getText(), auctionLotDescription.getText(), auctionLotType.getText(), auctionLotDate.getText(), auctionLotPrice.getText());
    ...
    void deletebid(ActionEvent event) {
        int itemToDelete = bidListView.getSelectionModel().getSelectedIndex();
        bids.delete(itemToDelete);
        loadbid();
        save();
    }
